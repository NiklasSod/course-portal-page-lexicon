    ...
    >
      ...
      <div className="bg-stone-50 rounded-lg border border-stone-300 p-8 max-w-8xl w-full">
        <h3 className="text-2xl font-semibold mb-2">
          Webbutveckling från grunden - Kommer snart
        </h3>
        ...
        <div className="grid grid-cols-2 md:flex gap-4 md:gap-8 mb-8 text-sm text-menu">
          <p>
            <span className="font-semibold">Start:</span> {getFutureDate()}
          </p>
          <p>
            <span className="font-semibold">Längd:</span> 8 veckor
          </p>
          <p>
            <span className="font-semibold">Nivå:</span> Nybörjare
          </p>
          <p>
            <span className="font-semibold">Pris:</span> 9 900 kr
          </p>
        </div>
