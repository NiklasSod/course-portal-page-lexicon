            ...
            <form id="contact-form" onSubmit={handleSubmit} className="flex flex-col gap-5 w-full max-w-xl mx-auto">
                ...
                <label htmlFor="name" className="flex flex-col gap-1 text-md font-bold">
                    ...
                    <input
                        ...
                        className={`bg-slate-800 border rounded-md px-4 py-2.5 outline-none focus:ring-2 ${
                            errors.name ? "border-red-500 focus:ring-red-400" : "border-slate-700 focus:ring-slate-400"
                        }`}
                        aria-required
                    />
                ...
                <label htmlFor="email"className="flex flex-col gap-1 text-md font-bold">
                    ...
                    <input
                        ...
                        className={`bg-slate-800 border rounded-md px-4 py-2.5 outline-none focus:ring-2 ${
                            errors.email ? "border-red-500 focus:ring-red-400" : "border-slate-700 focus:ring-slate-400"
                        }`}
                        aria-required
                    />
                ...
                <label htmlFor="message" className="flex flex-col gap-1 text-md font-bold">
                    ...
                    <textarea
                        ...
                        rows={5}
                        className={`bg-slate-800 border rounded-md px-4 py-2.5 outline-none focus:ring-2 resize-none ${
                            errors.message ? "border-red-500 focus:ring-red-400" : "border-slate-700 focus:ring-slate-400"
                        }`}
                        aria-required
                    />
